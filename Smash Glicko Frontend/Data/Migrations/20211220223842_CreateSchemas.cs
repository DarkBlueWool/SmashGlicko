        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1Wins = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Player2Wins = table.Column<byte[]>(type: "varbinary(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeagueGame = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TimeFrameIDs = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    InitalTimeFrameStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeFrameSpan = table.Column<long>(type: "bigint", nullable: false),
